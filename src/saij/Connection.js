...
class Connection extends BaseObject {
   ...
   * @param  {module:saij/Connection~Connectable} connectableA connectable object
   * @param  {module:saij/Connection~Connectable} connectableB connectable object
   */
  constructor(key, connectableA, connectableB) {
    super();
    ...
    this.cons_ = [connectableA, connectableB];
    this.conA_ = connectableA;
    this.conB_ = connectableB;
 ...
 * {@link module:saij/Connection~Connectable}s, a key will be created and a
 * new {@link module:saij/Connection~Connection} will be returned.
 * @api
 */
